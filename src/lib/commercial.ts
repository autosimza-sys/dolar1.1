...
export const commercialPlans: Record<PlanId, PlanConfig> = {
  essential_monthly: {
    ...
    price: 999,
    priceLabel: "$999/mes",
    message: "Lo básico para seguir el mercado sin complicarte.",
    cta: "Activar Básico",
    bullets: ["2 alertas por email", "Sin prueba gratis", "Cotizaciones completas", "Educación financiera gratis"],
    alertLimit: 2,
    hasTrial: false,
    trialDays: 0,
    whatsappLimit: 0
  ...
  premium_monthly: {
    ...
    message: "Pensado para quienes necesitan reaccionar primero.",
    cta: "Activar Premium",
    bullets: ["Todo lo del Plan Seguimiento", "Alertas por WhatsApp", "Prioridad", "Funciones premium futuras"],
